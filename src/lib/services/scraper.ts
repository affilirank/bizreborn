...
function mockScrape(input: ScrapeInput): ScrapeResult {
  ...
  return {
    ...
    competitor_name: `${input.city} Market Leader`,
    competitor_reviews: revs + 72,
    instagram: `@${cleanName}`,
    facebook: `${cleanName}official`,
    website: `https://www.${cleanName}fl.com`,
    phone: "772-555-0188",
    email: `info@${cleanName}fl.com`,
    audit_screenshot_url: "",
    website_preview_url: "",
  };
}
